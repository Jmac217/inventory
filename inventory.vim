...
set ignorecase
set incsearch
set runtimepath=~\\.vim\\bundle\\vundle,~\\.vim\\bundle\\vim-fugitive,~\\.vim\\bundle\\vim-easymotion,~\\.vim\\bundle\\sparkup\\vim\\,~\\.vim\\bundle\\vim-rails,~\\.vim\\bundle\\L9,~\\.vim\\bundle\\FuzzyFinder,~\\.vim\\bundle\\command-t,~\\.vim\\bundle\\vim-colorschemes,~/vimfiles,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim74,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after,~/vimfiles/bundle/vundle/,~\\.vim\\bundle\\vundle/after,~\\.vim\\bundle\\vim-fugitive/after,~\\.vim\\bundle\\vim-easymotion/after,~\\.vim\\bundle\\sparkup\\vim\\/after,~\\.vim\\bundle\\vim-rails/after,~\\.vim\\bundle\\L9/after,~\\.vim\\bundle\\FuzzyFinder/after,~\\.vim\\bundle\\command-t/after,~\\.vim\\bundle\\vim-colorschemes/after
set shiftwidth=2
set showmatch
set smartcase
set smarttab
...
badd +0 add.php
badd +26 view.php
badd +1 php\uploadXML.php
badd +0 php\updateXML.php
badd +78 php\headerSetter.php
badd +1 TODO
badd +1 README
badd +0 \xampp\htdocs\Jmac217\inventory\css\pages.css
args index.php css\index.css js\index.js js\add.js js\view.js js\functions.js add.php view.php php\uploadXML.php php\updateXML.php php\headerSetter.php TODO README
edit \xampp\htdocs\Jmac217\inventory\css\pages.css
...
exe 'vert 1resize ' . ((&columns * 79 + 118) / 236)
exe '2resize ' . ((&lines * 27 + 30) / 60)
exe 'vert 2resize ' . ((&columns * 79 + 118) / 236)
exe '3resize ' . ((&lines * 29 + 30) / 60)
exe 'vert 3resize ' . ((&columns * 38 + 118) / 236)
exe '4resize ' . ((&lines * 1 + 30) / 60)
exe 'vert 4resize ' . ((&columns * 118 + 118) / 236)
exe '5resize ' . ((&lines * 1 + 30) / 60)
exe 'vert 5resize ' . ((&columns * 118 + 118) / 236)
exe '6resize ' . ((&lines * 20 + 30) / 60)
exe 'vert 6resize ' . ((&columns * 79 + 118) / 236)
exe '7resize ' . ((&lines * 20 + 30) / 60)
exe 'vert 7resize ' . ((&columns * 38 + 118) / 236)
exe '8resize ' . ((&lines * 1 + 30) / 60)
exe 'vert 8resize ' . ((&columns * 118 + 118) / 236)
exe '9resize ' . ((&lines * 1 + 30) / 60)
exe 'vert 9resize ' . ((&columns * 118 + 118) / 236)
exe '10resize ' . ((&lines * 33 + 30) / 60)
exe 'vert 10resize ' . ((&columns * 40 + 118) / 236)
exe '11resize ' . ((&lines * 24 + 30) / 60)
exe 'vert 11resize ' . ((&columns * 40 + 118) / 236)
exe '12resize ' . ((&lines * 34 + 30) / 60)
exe 'vert 12resize ' . ((&columns * 76 + 118) / 236)
exe '13resize ' . ((&lines * 23 + 30) / 60)
exe 'vert 13resize ' . ((&columns * 76 + 118) / 236)
argglobal
edit \xampp\htdocs\Jmac217\inventory\css\pages.css
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 482 - ((19 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
482
let s:c = 42 - ((39 * winwidth(0) + 39) / 79)
if s:c > 0
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 131 - ((2 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
131
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 192 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
192
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((10 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
